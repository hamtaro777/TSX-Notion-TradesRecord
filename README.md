...
2. **データベースの準備**
   - Notionで下記リンクからデータベースを複製、もしくは新しいデータベースを作成
   - TSX-NOTION 接続テンプレート: `https://screeching-nail-64f.notion.site/23701da976c080ed9c29c717a74dd1c2?v=23701da976c081248913000c892be53f`
   - 1からデータベースを構築する場合は以下のプロパティを追加：
